...
export default async function AcceptProposalPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = await params;
  return <ActionPage action={ACTION_FORM_ACTIONS.ACCEPT_PROPOSAL} meetingId={id} />;
}
