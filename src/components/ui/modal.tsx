    ...
    <div className="fixed inset-0 z-50 grid place-items-center px-4 py-8">
      ...
      >
        <div className="mb-4 flex items-start justify-between gap-4">
          ...
          <button
            aria-label={closeLabel}
            className="grid size-8 place-items-center rounded-full text-muted-foreground transition-colors hover:bg-foreground/5 hover:text-foreground focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-foreground"
            onClick={onClose}
            type="button"
          >
