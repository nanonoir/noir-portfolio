...
export const EMAIL_PROVIDER_ERROR_CODES = {
  EMAIL_PROVIDER_AUTHENTICATION: "EMAIL_PROVIDER_AUTHENTICATION",
  EMAIL_PROVIDER_CONFIGURATION: "EMAIL_PROVIDER_CONFIGURATION",
  EMAIL_PROVIDER_ERROR: "EMAIL_PROVIDER_ERROR",
  EMAIL_PROVIDER_TIMEOUT: "EMAIL_PROVIDER_TIMEOUT",
  EMAIL_PROVIDER_TRANSIENT: "EMAIL_PROVIDER_TRANSIENT",
} as const;
